...
# concatenate lists (slower than 'extend')
neighbors = simpsons + ['ned', 'rod', 'todd']

# modifies in place (slower than 'extend')
simpsons += ["apu", "mr burns"]
...
languages | snakes          # returns union: {'cobra', 'r', 'java', 'viper', 'python'} ie all unique between both
languages - snakes          # returns set difference: {'r', 'java'} ie. unique to only the first set
snakes - languages          # returns set difference: {'cobra', 'viper'} ie. unique to only the first set
